...
SET PARAMETER     Connector:ConnectorInput string ConnectorInputAddress=   localhost:20320  // IP address/port to read from, e.g. localhost:20320


# SetConfig
#    SendConditioningParameters
#    GetSignalParameters