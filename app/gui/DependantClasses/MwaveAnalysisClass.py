...
class MWaveAnalysisWindow(tkinter.Toplevel, TkMPL):
    ...
    def initUI(self):
        ...
        self.parent.panel = self.panel = Bunch(
            MeanM=InfoItem('Mean M-wave:', 0, fmt='%.1f', units='V', color='#000000').tkc(self.frame, column=1),
            CurrentM=InfoItem('Current M-wave:', 0, fmt='%.1f', units='V', color='#000000').tkc(self.frame, column=3),
            LastM=InfoItem('Previous M-wave:', 0, fmt='%.1f', units='V', color='#000000').tkc(self.frame, column=5),
            CurrentH=InfoItem('Current H-reflex:', 0, fmt='%.1f', units='V', color='#000000').tkc(self.frame,column=7),
            Hmax=InfoItem('Hmax:', 0, fmt='%.1f', units='V', color='#000000').tkc(self.frame, column=9),
        )
