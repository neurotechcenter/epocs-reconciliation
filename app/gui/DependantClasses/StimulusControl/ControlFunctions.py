...
class CurrentControl(object):
    ...
    def __init__(self,parent,mode,EndPoint='Mmax',RCindex=None):
        ...
        if self.mode in ['st']:
            ...
            self.CurrentLimit = 15 #self.parent.operator.params._CurrentLimit
            ...
            if 'H' in self.Method:
				...
				self.h = StimControl(Setpoint=120,Gradient=0,N=3)
...
class StimControl(object):
    ...
    def __init__(self,Setpoint,Gradient,N=3):
        if False:
            ...
            self.beta = 0.75 # derivative control filtering parameter
